...
SWIFT_CLASS("_TtC6jinrou11AppDelegate")
...
SWIFT_CLASS("_TtC6jinrou15ViewController1")
@interface ViewController1 : UIViewController
@property (nonatomic, strong) IBOutlet UIButton * __null_unspecified plus;
@property (nonatomic, strong) IBOutlet UIButton * __null_unspecified minus;
@property (nonatomic, strong) IBOutlet UILabel * __null_unspecified label;
@property (nonatomic) NSInteger count;
@property (nonatomic, strong) AppDelegate * __nonnull appDelegate;
- (void)viewDidLoad;
...
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull n6;
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull n7;
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull m;
@property (nonatomic) NSInteger num;
@property (nonatomic, strong) UIAlertView * __nonnull alert;
@property (nonatomic, strong) AppDelegate * __nonnull appDelegate;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (void)a;
